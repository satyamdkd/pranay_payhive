...
class Recharge extends GetView<ElectricityController> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (controller.custName != null) const SizedBox(height: 6),
                  _billDetailRow("Bill due date:", controller.dueD!),
                  const SizedBox(height: 6),
                  _billDetailRow("Payable amount:",
                      "₹${controller.amountRupees!.toStringAsFixed(2)}"),
                  const SizedBox(height: 6),
                  _billDetailRow("Bill date:", controller.billD!),
                ],
              ),
            ),
            const Divider(height: 1.0, color: Color(0xFFE7E8EC)),
