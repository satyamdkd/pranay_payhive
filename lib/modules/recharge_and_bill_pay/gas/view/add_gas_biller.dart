...
class AddNewGas extends GetView<GasController> {
  const AddNewGas(this.billerName, this.billerData, {super.key});
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              if (billerName.toString().toLowerCase().contains('commercial'))
                Text(
                  ' Product Qty',
                  style: theme.textTheme.labelMedium?.copyWith(
              ...
              if (billerName.toString().toLowerCase().contains('commercial'))
                customTextField(
                  textEditingController: controller.productQty,
              ...
              if (billerName.toString().toLowerCase().contains('commercial'))
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: height / 80),
                    customTextField(
                      textEditingController: controller.svNumber,
                      maxLength: 10,
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(width / 50),
                        borderSide: BorderSide(
                        ...
                        onTap: () async {
                          ...
                          if (billerName
                            ...
                            customerParams.add({
                              ...
                              "value": controller.mobileNumber.text
                            });
                            customerParams.add({
                              "name": 'Product Qty',
                              "value": controller.productQty.text
                            });
                            customerParams.add({
                              "name": 'SV Number',
                              "value": controller.svNumber.text
                            });
                          } else {
                            customerParams.add({
                              "name": billerName.contains('HP')
                                  ? 'Mobile Number'
                          ...
                          await controller.getFastagBillFetchRequest(
