...
class AddNewFastag extends GetView<FastagController> {
  const AddNewFastag(this.billerName, this.billerData, {super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              customTextField(
                ...
                onChanged: (val) {
                  controller.subId.value = TextEditingValue(
                    text: val.toUpperCase(),
                    selection: controller.subId.selection,
                  );
                  controller.update();
                },
                inputFormatter: [
              ...
              if (controller.paramName.length > 1)
                Column(
                  ...
                  children: [
                    Text(
                      ' ${controller.paramName[1]} (Optional)',
                      style: theme.textTheme.labelMedium?.copyWith(
                        color: appColors.textDark.withValues(alpha: 0.8),
                        letterSpacing: 1,
                        fontWeight: FontWeight.w500,
