...
class Recharge extends GetView<FastagController> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _billDetailRow(
                      "Wallet Balance", controller.walletBalance.toString()),
                ],
              ),
            ),
            const Divider(height: 1.0, color: Color(0xFFE7E8EC)),
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color:
                              selected ? appColors.primaryColor : Colors.grey,
                          width: 0.5,
                        ),
                      ),
                      padding: const EdgeInsets.symmetric(
                ...
                : Padding(
                    ...
                    child: customButton(
                      ...
                      onTap: () async {
                        ...
                        } else if (controller.maxPermissibleAmount <
                            enteredAmount) {
                          errorDialog(
                            context: context,
                            message:
                                'You can currently pay up to ₹${controller.maxPermissibleAmount}, as your maximum permissible amount is less than the amount you entered.',
                          );
                        } else if (100 > double.parse(controller.amount.text)) {
                          errorDialog(
                            context: context,
                            message:
